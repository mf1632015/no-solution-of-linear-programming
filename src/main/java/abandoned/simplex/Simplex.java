package abandoned.simplex;


/*************************************************************************
 * 当线性规划约束条件全部都是<=时，使用一般的单纯形法，可能会出现无界解和无解
 ...
 *
 *  Creates an (M+1)-by-(N+M+1) abandon.simplex tableaux with the
...
public class Simplex {
    ...
    // sets up the abandon.simplex tableaux
    ...
    // run abandon.simplex algorithm starting from initial BFS
    private void solve() {
        while (true) {
