...
//import umlAnalysis.entity.Element;
...
public class LpModel {
	...
	public IloNumVar[] createModel(String constraints, IloMPModeler model, IloNumVar[][] var, String target)
			throws IloException {
...
//				System.out.println(splitConstraints[0]+"<="+splitConstraints[1]);
				//like 5<= a - b
				// save the bounds;
				lbArr[i] = Double.parseDouble(splitConstraints[0]);
				ubArr[i] = -1;
